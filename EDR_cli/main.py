...
script6win = directorio_script / "src" / "events" / "windows" / "events_monitor.py"
...
script6lin = directorio_script / "src" / "events" / "linux" / "events_monitor.py"


# Definir los scripts para cada sistema operativo
scripts_windows = [script1win, script2win, script3win, script4win, script5win, script6win]
