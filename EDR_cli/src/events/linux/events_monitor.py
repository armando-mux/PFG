...
reglas = [
    ...
    ["auditctl", "-a", "always,exit", "-F", "arch=b64", "-S", "keyctl", "-k", "kernel_key_operations"],
    ["auditctl", "-a", "always,exit", "-F", "arch=b64", "-S", "add_key", "-k", "key_management"],
    ["auditctl", "-a", "always,exit", "-F", "arch=b64", "-S", "request_key", "-k", "key_request"],
